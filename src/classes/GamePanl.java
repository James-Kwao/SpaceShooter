...
//    int addNewWordCounter = 0, msgXps = 190, gamePlayed = 1, changeExp;
//    GameWords explodingWord;
//    char keyTyped = '1';
...
//        if (circle > Main.screenSize.width * 2) circle = 0;
//
//        drawStars(g2);
...
////            drawMainMenu(g2);
//        } else {
//            if (gameWords.size() <= 30) addNewWord(g2);
...
//        if (explosion != null) {
//            changeExp++;
//            int x = (int) (explodingWord.getCenterX() - explosion.getWidth(null) / 2F);
//            int y = (int) (explodingWord.getCenterY() - explosion.getHeight(null) / 2F);
//
//
...
//            if (changeExp == 13) {
//                gameWords.remove(explodingWord);
//                explosion = null;
//                changeExp = 0;
//            }
//        }
